    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('perfil_url', models.URLField(blank=True, max_length=300, null=True)),
                ...
                ('perfil_completo', models.BooleanField(default=False, help_text='Indica si el usuario completó su perfil', verbose_name='Perfil completo')),
                ('usuario_unico', models.CharField(blank=True, help_text='Nombre de usuario único (nickname público)', max_length=100, unique=True, verbose_name='Usuario único')),
